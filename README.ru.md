...
глубоко в закрашенной политической карте.
...
| файл | что |
| --- | --- |
| `gfx/map/map_object_data/game_object_layers.txt` | семь слоёв AGOT; `activities_layer` 9 → 7, `AGOT_animal_layer` 9 → 8, `unit_layer` 9 → 10, `building_layer`, `AGOT_building_layer`, `AGOT_roads`, `AGOT_low_roads` 16 → 10; плюс новый `AGOT_skybox_layer` на 16 |
| `gfx/map/map_object_data/skyx_skybox.txt` | файл AGOT, где скайбокс перенесён на `AGOT_skybox_layer`, чтобы он держал 16-й шаг AGOT, пока слой зданий, который он делил, уходит на 10-м |
...
| что выгружается / переключается | трава | активности, пена у берега | животные, горные и прочие эффекты окружения | `tree_low`, `tree_medium` | владения, города, дороги и мосты AGOT, армии, начало заливки цветом, иконки крепостей и набегов, затухание тумана войны AGOT | крупные названия | скайбокс, `tree_high` |

### Почему владения уходят на 10-м шаге
...
FPS на карте AGOT. 10-й шаг — начало заливки (базовый мод переносит его туда с 9-го), так
что модели уходят вместе с приходом цвета.
...
Они тоже уходят на 10-м, так что ни один город не переживает заливку, когда Королевская
Гавань и все баронства уже пропали. Скайбокс AGOT делит `AGOT_building_layer`; он вынесен
на собственный слой с 16-м шагом AGOT, иначе море за краем карты теряло бы небо на 10-м.
